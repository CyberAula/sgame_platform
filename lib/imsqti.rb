...
class IMSQTI
  ...
  def self.generate_QTITF(qjson,index)
    ...
    title_identifier = "AssesmentItem " + (Time.now.to_i.to_s + index.to_s)
  ...
  def self.generate_QTIMC(qjson)
    ...
    nChoices = qjson["choices"].size
    title_identifier = "AssesmentItem " + (Time.now.to_i.to_s)
  ...
  def self.generate_mainQTIMC(qjson,fileName)
    ...
    resource_identifier = "resource-item-quiz-" + identifier
    test_identifier = "test-identifier" + identifier
    section_identifier = "section-identifier" + identifier
  ...
  def self.generate_qti_resources(qjson,fileName,myxml)
    resource_identifier = "resource-item-quiz-" + (Time.now.to_i.to_s)
