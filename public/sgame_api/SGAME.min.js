...
break;case "n_los":f=Math.min(a.game_settings.completion_status_n,e);c=0===f?1:b/f;break;case "n_times":c=0>=a.game_settings.completion_status_n?1:l/a.game_settings.completion_status_n}c=Math.max(Math.min(1,+c.toFixed(2)),0);d=1===c?"completed":"incompleted"}var f=0,g="unknown";if("number"===typeof a.game_settings.success_status_n){switch(a.game_settings.success_status){case "percentage_los":a.game_settings.success_status_n=Math.min(100,Math.max(0,a.game_settings.success_status_n))/100;f=0>=a.game_settings.success_status_n||
0>=e?1:h/e/a.game_settings.success_status_n;break;case "n_los":f=Math.min(a.game_settings.success_status_n,e);f=0===f?1:b/f;break;case "n_times":f=0>=a.game_settings.success_status_n?1:n/a.game_settings.success_status_n}f=Math.max(Math.min(1,+f.toFixed(2)),0);g=1===f?"passed":"failed"}u={progress_measure:c,completion_status:d,score:f,success_status:g};SGAME.Messenger.sendMessage({key:"tracking",value:u})},F=function(a){!0!==G()?"function"===typeof a&&a(!1):H(a)},G=function(){if(!0===v)return!1;switch(a.game_settings.completion_notification){case "no_more_los":return!1===
t;case "all_los_consumed":for(var b=Object.keys(a.los),c=b.length,d=0;d<c;d++)if(!1===a.los[b[d]].shown)return!1;return!0;case "all_los_succesfully_consumed":b=Object.keys(a.los);c=b.length;for(d=0;d<c;d++)if(!1===a.los[b[d]].succesfully_consumed)return!1;return!0;case "never":return!1;default:return!1}},H=function(a){v=!0;SGAME.Fancybox.create({dialog:!0,msg:w},function(){"function"===typeof a&&a(!0)})},C=function(a){return{lo_metadata:void 0,time:void 0,scorm_success_status:void 0,scorm_scaled_score:void 0,
scorm_completion_status:void 0,scorm_progress_measure:void 0,success:B(a),more_los:t}},B=function(b){var c;p&&"undefined"!==typeof a.game_settings.behaviour_when_no_more_los?c=a.game_settings.behaviour_when_no_more_los:"undefined"!==typeof d.behaviour_when_no_more_los?c=d.behaviour_when_no_more_los:"undefined"!==typeof a.game_settings.behaviour_when_no_more_los&&(c=a.game_settings.behaviour_when_no_more_los);return I(c,b)},I=function(a,b){switch(a){case "success":return!0;case "failure":return!1;
case "success_unless_damage":var c=D(b);return"undefined"!==typeof c&&"damage"===c.type?!1:!0;case "failure_unless_blocking":return c=D(b),"undefined"===typeof c||"blocking"!==c.type?!1:!0;default:return!1}},D=function(b){return"undefined"!==typeof a.events[b]?a.events[b]:"object"===typeof d.events&&"undefined"!==typeof d.events[b]?d.events[b]:{}};SGAME.Debugger.init(!1);!1===p&&k({});SGAME.Messenger.init();return{init:function(a){SGAME.Debugger.log("SGAME init with options ");SGAME.Debugger.log(a);
(d=a)&&"function"===typeof a.togglePause&&(g=a.togglePause)},loadSettings:function(a){SGAME.Debugger.log("SGAME load settings ");SGAME.Debugger.log(a);p=!0;k(a)},triggerLO:function(a,b){var c=y(a);if(1>c.length){if("function"===typeof b){var d=C(a);b(d.success,d)}}else if(c=z(c),0<c.length){for(var e=[],f=0;f<c.length;f++)"undefined"===typeof d&&(d=c[f].nshown),c[f].nshown<d&&(d=c[f].nshown,e=[]),d===c[f].nshown&&e.push(c[f]);selectedLO=SGAME.Utils.getRandomElement(e);x(selectedLO,b)}else"function"===
typeof b&&(d=C(a),b(d.success,d))},showLO:x,showRandomLO:function(a){SGAME.API.requestLOMetadata(void 0,function(b){x(b,a)},function(){"function"===typeof a&&a(null,null)})},closeLO:function(){SGAME.Fancybox.closeCurrentFancybox()},getSettings:function(){return a},losCanBeShown:function(a){return!1===t?!1:"undefined"===typeof a?t:0<z(y(a)).length},successWhenNoLOs:function(a){return B(a)},getVLEData:function(){return m},setVLEData:function(a){return m=a}}}();var API,API_1484_11;
