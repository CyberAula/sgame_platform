...
typeof a.game_settings.success_status_n&&(a.game_settings.success_status="disabled",delete a.game_settings.success_status_n);-1===h.indexOf(a.game_settings.completion_notification)&&(a.game_settings.completion_notification="never");-1===n.indexOf(a.game_settings.behaviour_when_no_more_los)&&(a.game_settings.behaviour_when_no_more_los="success_unless_damage");"string"===typeof a.game_settings.completion_notification_text&&(l=a.game_settings.completion_notification_text);if("object"===typeof a.los){c=
Object.keys(a.los);v=c.length;for(var f=0;f<v;f++)"undefined"!==typeof a.los[c[f]].url&&(a.los[c[f]].url=SGAME.Utils.checkUrlProtocol(a.los[c[f]].url)),a.los[c[f]].can_be_shown=!0,a.los[c[f]].shown=!1,a.los[c[f]].nshown=0,a.los[c[f]].succesfully_consumed=!1,a.los[c[f]].nsuccess=0,a.los[c[f]].acts_as_asset="asset"===a.los[c[f]].scorm_type||"sco"===a.los[c[f]].scorm_type&&!1===a.los[c[f]].report_data,q=!0}"random"!==a.sequencing.approach&&(c=SGAME.Sequencing.validateSequence(a.sequencing.sequence,a.los),
!1===c?a.sequencing.approach="random":a.sequencing.sequence=c);"random"===a.sequencing.approach&&delete a.sequencing.sequence;if("object"===typeof a.sequencing.sequence){c=Object.keys(a.los);v=c.length;for(f=0;f<v;f++)a.los[c[f]].can_be_shown=!1,a.los[c[f]].groups=[];q=!1;c=Object.keys(a.sequencing.sequence);_nGroups=c.length;for(f=0;f<_nGroups;f++){var g=a.sequencing.sequence[c[f]];g.can_be_shown="undefined"===typeof g.conditions||0===g.conditions.length;g.shown=!1;g.succesfully_consumed=!1;if("undefined"!==
typeof g.conditions)for(var m=0;m<g.conditions.length;m++)g.conditions[m].met=!1;a.sequencing.sequence[c[f]]=g;for(m=0;m<g.los.length;m++)a.los[g.los[m]].groups.push(g.id),a.los[g.los[m]].can_be_shown=!0===g.can_be_shown,!0===a.los[g.los[m]].can_be_shown&&(q=!0)}}SGAME.Sequencing.init(a.sequencing)},D=function(b,d){var c=F(b);if(1>c.length)return B(b,d);var e=G(c);if(0<e.length){c=void 0;switch(a.sequencing.approach){case "linear_completion":case "linear_success":case "custom":if(!1===g){for(var c=
[],h=[],f=[],k=0;k<e.length;k++)f.push(e[k].id);for(var e=Object.keys(a.sequencing.sequence),m=0;m<e.length;m++){var l=a.sequencing.sequence[e[m]];if(!0===l.can_be_shown)for(k=0;k<l.los.length;k++)-1!==f.indexOf(l.los[k])&&-1===h.indexOf(l.los[k])&&(h.push(l.los[k]),c.push(a.los[l.los[k]]))}}else c=e;c=H(c);break;default:c=H(e)}selectedLO=c;C(selectedLO,d)}else"function"===typeof d&&(c=I(b),d(c.success,c))},B=function(a,b){if("function"===typeof b){var d=I(a);b(d.success,d)}},F=function(b){var d=
