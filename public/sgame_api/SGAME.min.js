...
a=function(b,a){var e=new XMLHttpRequest;e.onreadystatechange=function(){if(4==e.readyState&&200==e.status){var b=JSON.parse(e.responseText);a(b)}};e.open("GET",b,!0);e.send("")},h=function(b){var a;a=[];for(var e=0;e<b.length;e++)!1===b[e].marked&&a.push(b[e]);if(0<a.length)a=g(a);else{for(e=0;e<b.length;e++)b[e].marked=!1;a=g(b)}"undefined"!=typeof a&&(b[b.indexOf(a)].marked=!0);return{lo:a,los:b}},g=function(b){if("number"==typeof b)return b;var a;a=b.length-1;if("number"!=typeof a)throw{name:"Invalid number format exception"};
...
[];for(var d=0;d<e.los_id.length;d++)f[e.event_id].los.push({id:e.los_id[d],marked:!1})}},triggerLO:function(b,a){var e=f[b].los;if(e){var c;a:{for(c=0;c<e.length;c++)if("*"===e[c].id){c=!0;break a}c=!1}c?(e=h(q),q=e.los):(e=h(e),f[b].los=e.los);"undefined"!=typeof e.lo?r(u[e.lo.id],a):"function"==typeof a&&a(null,null)}},showLO:r,showRandomLO:function(b){d(x,function(a){r(a,b)},function(){"function"==typeof b&&b(null,null)})},closeLO:function(){v.closeCurrentFancybox()}}}();SGAME.VERSION="0.2";
SGAME.AUTHORS="Aldo Gordillo, Enrique Barra";SGAME.URL="http://github.com/agordillo/sgame";SGAME.EVENT={};SGAME.EVENT.GENERIC="generic";SGAME.EVENT.EXTRA_LIFE="extra_life";SGAME.EVENT.EXTRA_SKILL="extra_skill";SGAME.EVENT.EXTRA_ITEM="extra_item";SGAME.EVENT.BLOCKER="blocker";SGAME.EVENT.CHEAT="cheat";SGAME.EVENT.CONTINUE="continue";
