...
audio:"0",language:"",speed:"0",text:"0"},score:{_children:"raw,min,max",raw:"",max:"",min:""},total_time:"0000:00:00.00",session_time:"",exit:""},student_data:{_children:"mastery_score,time_limit_action,max_time_allowed",mastery_score:"50",max_time_allowed:"",time_limit_action:"continue,no message"}}},g),p={},f={0:"No error",101:"General exception",102:"General Initialization Failure",103:"Already Initialized",104:"Content Instance Terminated",111:"General Termination Failure",112:"Termination Before Initialization",
...
Math.min(1,(d-f)/e));l("cmi.score.scaled",d)}x=x.replace("cmi.","");m(x,w,p)}return"true"}b.errorCode=b.terminated?133:132;return"false"};this.LMSCommit=function(){v("StoreData",{runtimedata:p});return"true"};this.LMSTerminate=function(){h.LMSCommit();b.terminated=1;b.initialized=0;return"true"};this.LMSFinish=function(){h.LMSCommit();b.terminated=1;b.initialized=0;return"true"};this.LMSGetErrorString=function(a){return""!==a&&(a=parseInt(a,10),void 0!==f[a])?f[a]:""};this.LMSGetLastError=function(){return b.errorCode};
...
a.score;default:return!0===a.shown}},u=function(a,d){switch(a.type){case "single":if(a.group===d.id)return[a];break;case "multiple":for(var b=[],c=0;c<a.conditions.length;c++)b=b.concat(u(a.conditions[c],d));return b}return[]},v=function(a,d,b){for(var c=0;c<a.los.length;c++)d[a.los[c]].can_be_shown=b;return d},b=void 0,p=void 0,f=function(a,d){if("undefined"===typeof p){if("undefined"!==typeof d){for(var c=[],f=Object.keys(d),l=0;l<f.length;l++)"undefined"!==typeof d[f[l]].groups&&0!==d[f[l]].groups.length||
c.push(f[l]);p=c.length}p=0}switch(g){case "linear_success":case "linear_completion":if("undefined"!==typeof b)return b;for(var c=0,f=Object.keys(a),l=f.length,e=0;e<l;e++)c+=a[f[e]].los.length;break;case "custom":c=h(a);break;default:c=0}return b=c+p},h=function(a){a=JSON.parse(JSON.stringify(a));for(var d=Object.keys(a),b=d.length,c=[],f=0;f<b;f++){var e=a[d[f]];if(!1===e.unlocked&&"undefined"!==typeof e.condition&&!1===e.locked)for(var l=0;l<b;l++){var g=a[d[l]];if(!0===g.unlocked&&!1===g.locked&&
g.id!==e.id){var m=u(e.condition,g);if(0<m.length&&!1===m[0].met){var n=m[0],q={conditionsToMet:[],groupsToLock:[],groupsToUnlock:[]};q.conditionsToMet.push({id:n.id,group:e.id});q.groupsToLock.push(g.id);"multiple"===e.condition.type&&"OR"===e.condition.operator||"single"===e.condition.type?q.groupsToUnlock.push(e.id):"multiple"===e.condition.type&&"AND"===e.condition.operator&&!0===r(n.id,JSON.parse(JSON.stringify(e.condition))).met&&q.groupsToUnlock.push(e.id);for(n=0;n<b;n++){var p=a[d[n]];if(!1===
p.unlocked&&!1===p.locked&&p.id!==e.id&&p.id!==g.id&&"undefined"!==typeof p.condition){var s=u(p.condition,g);if(0<s.length&&!1===s[0].met){var v=!1;switch(m[0].requirement){case "completion":case "completion_higher_inmediate":v=!0;break;case "success":v=-1===["fail","score_lower"].indexOf(s[0].requirement);break;case "fail":v=-1!==["score_higher","score_higher_inmediate","score_lower"].indexOf(s[0].requirement)?100!==s[0].threshold:-1===["success"].indexOf(s[0].requirement);break;case "score_higher":case "score_higher_inmediate":v=
...
q.groupsToUnlock.push(p.id):"multiple"===p.condition.type&&"AND"===p.condition.operator&&!0===r(s[0].id,JSON.parse(JSON.stringify(p.condition))).met&&q.groupsToUnlock.push(p.id))}}}c.push(q)}}}}d=c.length;if(0===d){c=0;d=Object.keys(a);b=d.length;for(f=0;f<b;f++)e=a[d[f]],!0===e.unlocked&&Array.isArray(e.los)&&(c+=e.los.length);return c}for(f=b=0;f<d;f++){e=JSON.parse(JSON.stringify(a));for(l=0;l<c[f].groupsToLock.length;l++)e[c[f].groupsToLock[l]].locked=!0;for(l=0;l<c[f].groupsToUnlock.length;l++)e[c[f].groupsToUnlock[l]].unlocked=
...
a.approach},initGroupSequence:function(a){a.can_be_shown="undefined"===typeof a.condition||0===Object.keys(a.condition).length;a.locked=!1;a.unlocked=a.can_be_shown;a.shown=!1;a.nshown=0;a.score=!1;a.performance=0;a.condition=q(a.condition);return a},validateSequence:function(b,d){if("object"!==typeof b||"object"!==typeof d)return!1;for(var c=Object.keys(b),f=Object.keys(d),l=0;l<c.length;l++){var e;e=b[c[l]];var h=f;if("undefined"===typeof e.id)e=!1;else{e.id+="";for(var g=[],m=0;m<e.los.length;m++){var n=
e.los[m];-1!==h.indexOf(n)&&g.push(n)}e.los=g;e=1>e.los.length?!1:e}!1!==e?b[c[l]]=e:delete b[c[l]]}b=a(b);c=Object.keys(b);f=[];for(l=0;l<c.length;l++)for(e=b[c[l]],h=0;h<e.los.length;h++)-1===f.indexOf(e.los[h])&&f.push(e.los[h]);return 2>typeof c.length||2>f.length?!1:b},getNLOsForTracking:f,updateGroupsTracking:function(a,d,c){for(var h=a.groups.length,g=0;g<h;g++){var e=d[a.groups[g]];if(!0===e.can_be_shown){for(var m=d,p=a.groups[g],q=e.los.length,r=0,s=0,u=0;u<q;u++){var B=c[e.los[u]];!0===
B.shown&&(r+=1);!0===B.successfully_consumed&&(s+=1)}e.shown=r===q;e.nshown=r;e.score=0<q?s/q:0;e.performance=0<r?s/r:0;m[p]=e}}g=!1;p=Object.keys(d);m=p.length;for(q=0;q<m;q++)e=d[p[q]],!1===e.unlocked&&!1===e.locked&&(r=d,s=p[q],!0!==e.locked&&!0!==e.unlocked&&("undefined"!==typeof e.condition?(e.condition=n(e.condition,d),!0===e.condition.met&&(e.unlocked=!0,e.can_be_shown=!0)):(e.unlocked=!0,e.can_be_shown=!0)),r[s]=e,!0===d[p[q]].unlocked&&(c=v(d[p[q]],c,!0),g=!0));for(q=0;q<h;q++)e=d[a.groups[q]],
!0===e.unlocked&&!1===e.locked&&(r=d,s=a.groups[q],!0!==e.locked&&!1!==e.unlocked&&(u=l(e,d),e.locked=u,e.can_be_shown=!1===e.locked),r[s]=e,!0===d[a.groups[q]].locked&&(c=v(d[a.groups[q]],c,!1),g=!0));a=!0;for(h=0;h<m;h++)if(e=d[p[h]],!0===e.unlocked&&!1===e.locked){a=!1;break}if(a)for(h=Object.keys(c),p=0;p<h.length;p++)if("undefined"===typeof c[h[p]].groups||0===c[h[p]].groups.length)c[h[p]].can_be_shown=!0;!0===g&&25>=m&&(b=f(d,c));return{groups:d,los:c,nLOsForTracking:b,finished:a}}}}();SGAME.Analytics=function(g){var c,q,a,m,s=function(){return n("http://activitystrea.ms/schema/1.0/access",q)},n=function(l,g,n,b){var p={};"undefined"!==typeof l&&(p.verb={id:l});"undefined"!==typeof g&&(p.object={id:g});"undefined"!==typeof n&&(p.result=n);p.timestamp=iso8601Parser.createTimestamp();!0===b&&(l=p,"undefined"!==typeof c&&(l.actor=c),g={},"object"==typeof l.object&&"string"==typeof l.object.id&&l.object.id!=q&&(g.contextActivities={parent:{id:q}}),"string"===typeof a&&(g.extensions=
{"http://id.tincanapi.com/extension/attempt-id":a}),0<Object.keys(g).length&&(l.context=g),l.authority={name:SGAME.URL,version:SGAME.VERSION},p=l);m.push(p);return p};return{init:function(l){"object"==typeof l.player&&"string"==typeof l.player.url&&"string"==typeof l.player.name&&(c={},c.id=l.player.url,c.name=l.player.name);q=l.game_metadata.url;"string"==typeof l.attemptId&&(a=l.attemptId);m=[];s()},onVLEDataReceived:function(a){if("object"===typeof a.user){var g={};"string"===typeof a.user.id&&
(g.id=a.user.id);"string"===typeof a.user.name&&(g.name=a.user.name);0<Object.keys(g).length&&"undefined"===typeof c&&(c=g,s())}},recordGameAccessed:s,recordGameClosed:function(a){return n("http://activitystrea.ms/schema/1.0/close",q,{completion:"completed"===a.completion_status,success:"passed"===a.success_status,score:{scaled:a.score}})},recordGameCompleted:function(a){return n("http://activitystrea.ms/schema/1.0/complete",q,{completion:"completed"===a.completion_status,success:"passed"===a.success_status,
score:{scaled:a.score}})},recordLOAccessed:function(a){return n("http://activitystrea.ms/schema/1.0/access",a.url)},recordLOClosed:function(a,c){return n("http://activitystrea.ms/schema/1.0/close",a.url,{completion:"completed"===c.scorm_completion_status,success:c.success,score:{scaled:c.scorm_scaled_score}})},storeAnalytics:function(){}}}();SGAME.API=function(){var g=function(c,g){var a=new XMLHttpRequest;a.onreadystatechange=function(){if(4==a.readyState&&200==a.status){var c=JSON.parse(a.responseText);g(c)}};a.open("GET",c,!0);a.send("")};return{init:function(){},requestLOMetadata:function(c,q,a){try{g("undefined"==typeof c?"/lo/random/metadata.json":"/lo/"+c+"/metadata.json",function(a){q(a)})}catch(m){a(m)}}}}();SGAME.CORE=function(){var g={},c=void 0,q="Congratulations. You have achieved the objectives of this educational game. You may close this window or continue playing.",a={},m=!1,s={},n={progress_measure:0,completion_status:"incompleted",score:0,success_status:"unknown"},l=["repeat","repeat_unless_successfully_consumed","no_repeat"],u=["no_restrictions","n_times","1_per_timeperiod"],v=["random","linear_completion","linear_success","custom"],b="all_los percentage_los n_los n_times disabled onstart".split(" "),
p="all_los percentage_los n_los n_times disabled onstart oncompletion".split(" "),f="no_more_los all_los_consumed all_los_successfully_consumed completion_status success_status never".split(" "),h=["success","failure","success_unless_damage","failure_unless_blocking"],r=!1,k=0,d=0,x=0,w=0,y=0,e=!1,t=void 0,z=!1,C=!1,E=0,A=!1,F=function(b,d){var c=H(b);if(1>c.length)return B(b,d);var e=I(c);if(0<e.length){c=void 0;switch(a.sequencing.approach){case "linear_completion":case "linear_success":case "custom":if(!0===
z&&!1===C){for(var c=[],h=[],f=[],k=0;k<e.length;k++)f.push(e[k].id);e=Object.keys(a.sequencing.sequence);for(k=0;k<e.length;k++){var l=a.sequencing.sequence[e[k]];if(!0===l.can_be_shown)for(var g=0;g<l.los.length;g++)-1!==f.indexOf(l.los[g])&&-1===h.indexOf(l.los[g])&&(h.push(l.los[g]),c.push(a.los[l.los[g]]))}}else c=e;c=J(c);break;default:c=J(e)}selectedLO=c;G(selectedLO,d)}else"function"===typeof d&&(c=K(b),d(c.success,c))},B=function(a,b){if("function"===typeof b){var d=K(a);b(d.success,d)}},
H=function(b){var d=[];b=a.event_mapping[b];if("undefined"!==typeof b){var c=b.length;if("number"===typeof c)for(var e=0;e<c;e++){if("*"===b[e]){d=[];b=Object.keys(a.los);for(c=0;c<b.length;c++)"undefined"!==typeof a.los[b[c]]&&d.push(a.los[b[c]]);break}"undefined"!==typeof a.los[b[e]]&&d.push(a.los[b[e]])}}return d},I=function(a){for(var b=[],d=a.length,c=0;c<d;c++)!0===a[c].can_be_shown&&b.push(a[c]);return b},G=function(b,d){"object"!==typeof b||"string"!==typeof b.url?"function"===typeof d&&d(null,
null):(t=new Date,D(),a.los[b.id].shown=!0,a.los[b.id].nshown+=1,!0===A&&SGAME.Analytics.recordLOAccessed(b),SGAME.Fancybox.create({lo:b},function(c){!0!==a.los[b.id].successfully_consumed&&(a.los[b.id].successfully_consumed=c.success);!0===c.success?a.los[b.id].nsuccess+=1:a.los[b.id].unsuccessfully_consumed=!0;if(!0===z&&!1===C){var e=SGAME.Sequencing.updateGroupsTracking(a.los[b.id],a.sequencing.sequence,a.los);a.sequencing.sequence=e.groups;a.los=e.los;E=e.nLOsForTracking;e.finished&&(C=!0)}switch(a.sequencing.repeat_lo){case "repeat_unless_successfully_consumed":a.los[b.id].can_be_shown=
!0!==a.los[b.id].successfully_consumed;break;case "no_repeat":a.los[b.id].can_be_shown=!1}P();c.more_los=r;!0===A&&SGAME.Analytics.recordLOClosed(b,c);L(function(){"function"===typeof d&&d(c.success,c);D()})}))},D=function(){"function"===typeof c&&c()},P=function(){var b=Object.keys(a.los);k=b.length;y=w=x=d=0;r=!1;for(var c=0;c<k;c++)!0===a.los[b[c]].shown&&(d+=1,x+=a.los[b[c]].nshown),!0===a.los[b[c]].successfully_consumed&&(w+=1,y+=a.los[b[c]].nsuccess),!0===a.los[b[c]].can_be_shown&&(r=!0);b=
k;!0===z&&(b=!0===C?d:E);var c=0,e="incompleted";switch(a.game_settings.completion_status){case "all_los":a.game_settings.completion_status_n=100;case "percentage_los":var h=Math.min(100,Math.max(0,a.game_settings.completion_status_n))/100,c=0>=h||0>=b?1:d/b/h;break;case "n_los":h=Math.min(a.game_settings.completion_status_n,b);c=0===h?1:d/h;break;case "n_times":c=0>=a.game_settings.completion_status_n?1:x/a.game_settings.completion_status_n;break;case "onstart":c=1}c=Math.max(Math.min(1,+c.toFixed(2)),
0);e=1===c?"completed":"incompleted";h=0;switch(a.game_settings.success_status){case "all_los":a.game_settings.success_status_n=100;case "percentage_los":h=Math.min(100,Math.max(0,a.game_settings.success_status_n))/100;h=0>=h||0>=b?1:w/b/h;break;case "n_los":h=Math.min(a.game_settings.success_status_n,b);h=0===h?1:d/h;break;case "n_times":h=0>=a.game_settings.success_status_n?1:y/a.game_settings.success_status_n;break;case "oncompletion":h=c;break;case "onstart":h=1}h=Math.max(Math.min(1,+h.toFixed(2)),
0);n={progress_measure:c,completion_status:e,score:h,success_status:1===h?"passed":"failed"};SGAME.Debugger.log("Tracking");SGAME.Debugger.log(n);SGAME.Messenger.sendMessage({key:"tracking",value:n})},L=function(a){!0!==M()?"function"===typeof a&&a(!1):Q(a)},M=function(){if(!0===e)return!1;var b=k;!0===z&&!0===C&&(b=d);switch(a.game_settings.completion_notification){case "no_more_los":return!1===r;case "all_los_consumed":return d>=b;case "all_los_successfully_consumed":return w>=b;case "completion_status":return"completed"===
n.completion_status;case "success_status":return"passed"===n.success_status;case "never":return!1;default:return!1}},Q=function(a){e=!0;!0===A&&SGAME.Analytics.recordGameCompleted(n);SGAME.Fancybox.create({dialog:!0,msg:q},function(){"function"===typeof a&&a(!0)})},J=function(a){for(var b=[],d,c=0;c<a.length;c++)"undefined"===typeof d&&(d=a[c].nshown),a[c].nshown<d&&(d=a[c].nshown,b=[]),d===a[c].nshown&&b.push(a[c]);return SGAME.Utils.getRandomElement(b)},K=function(a){return{lo_metadata:void 0,time:void 0,
scorm_success_status:void 0,scorm_scaled_score:void 0,scorm_completion_status:void 0,scorm_progress_measure:void 0,success:N(a),more_los:r}},N=function(b){var d;m&&"undefined"!==typeof a.game_settings.behaviour_when_no_more_los?d=a.game_settings.behaviour_when_no_more_los:"undefined"!==typeof g.behaviour_when_no_more_los?d=g.behaviour_when_no_more_los:"undefined"!==typeof a.game_settings.behaviour_when_no_more_los&&(d=a.game_settings.behaviour_when_no_more_los);return R(d,b)},R=function(a,b){switch(a){case "success":return!0;
case "failure":return!1;case "success_unless_damage":var d=O(b);return"undefined"!==typeof d&&"damage"===d.type?!1:!0;case "failure_unless_blocking":return d=O(b),"undefined"===typeof d||"blocking"!==d.type?!1:!0;default:return!1}},O=function(b){return"undefined"!==typeof a.events[b]?a.events[b]:"object"===typeof g.events&&"undefined"!==typeof g.events[b]?g.events[b]:{}};SGAME.Debugger.init(!1);return{init:function(a){SGAME.Debugger.log("SGAME init with options ");SGAME.Debugger.log(a);(g=a)&&"function"===
typeof a.togglePause&&(c=a.togglePause);window.addEventListener("unload",function(){!0===m&&!0===A&&(SGAME.Analytics.recordGameClosed(n),SGAME.Analytics.storeAnalytics())})},loadSettings:function(d){SGAME.Debugger.log("SGAME load settings ");SGAME.Debugger.log(d);m=!0;a=d;"undefined"===typeof a.game_metadata&&(a.game_metadata={});"undefined"===typeof a.los&&(a.los={});"undefined"===typeof a.events&&(a.events={});"undefined"===typeof a.event_mapping&&(a.event_mapping={});"undefined"===typeof a.sequencing&&
(a.sequencing={});-1===l.indexOf(a.sequencing.repeat_lo)&&(a.sequencing.repeat_lo="repeat");-1===u.indexOf(a.sequencing.interruptions)&&(a.sequencing.interruptions="no_restrictions");-1===v.indexOf(a.sequencing.approach)&&(a.sequencing.approach="random");-1!==["n_times","1_per_timeperiod"].indexOf(a.sequencing.interruptions)&&"number"===typeof a.sequencing.interruptions_n||delete a.sequencing.interruptions_n;-1!==["n_times","1_per_timeperiod"].indexOf(a.sequencing.interruptions)&&"number"!==typeof a.sequencing.interruptions_n&&
(a.sequencing.interruptions="no_restrictions");"undefined"===typeof a.game_settings&&(a.game_settings={});-1===b.indexOf(a.game_settings.completion_status)&&(a.game_settings.completion_status="disabled");-1!==["percentage_los","n_los","n_times"].indexOf(a.game_settings.completion_status)&&"number"===typeof a.game_settings.completion_status_n||delete a.game_settings.completion_status_n;-1!==["percentage_los","n_los","n_times"].indexOf(a.game_settings.completion_status)&&"number"!==typeof a.game_settings.completion_status_n&&
(a.game_settings.completion_status="disabled",delete a.game_settings.completion_status_n);-1===p.indexOf(a.game_settings.success_status)&&(a.game_settings.success_status="disabled");-1!==["percentage_los","n_los","n_times"].indexOf(a.game_settings.success_status)&&"number"===typeof a.game_settings.success_status_n||delete a.game_settings.success_status_n;-1!==["percentage_los","n_los","n_times"].indexOf(a.game_settings.success_status)&&"number"!==typeof a.game_settings.success_status_n&&(a.game_settings.success_status=
"disabled",delete a.game_settings.success_status_n);-1===f.indexOf(a.game_settings.completion_notification)&&(a.game_settings.completion_notification="never");-1===h.indexOf(a.game_settings.behaviour_when_no_more_los)&&(a.game_settings.behaviour_when_no_more_los="success_unless_damage");"string"===typeof a.game_settings.completion_notification_text&&(q=a.game_settings.completion_notification_text);if("object"===typeof a.los){var c=Object.keys(a.los);k=c.length;for(var e=0;e<k;e++)"undefined"!==typeof a.los[c[e]].url&&
(a.los[c[e]].url=SGAME.Utils.checkUrlProtocol(a.los[c[e]].url)),a.los[c[e]].can_be_shown=!0,a.los[c[e]].shown=!1,a.los[c[e]].nshown=0,a.los[c[e]].successfully_consumed=!1,a.los[c[e]].nsuccess=0,a.los[c[e]].unsuccessfully_consumed=!1,a.los[c[e]].acts_as_asset="asset"===a.los[c[e]].scorm_type||"sco"===a.los[c[e]].scorm_type&&!1===a.los[c[e]].report_data,r=!0}"random"!==a.sequencing.approach&&(c=SGAME.Sequencing.validateSequence(a.sequencing.sequence,a.los),!1===c?a.sequencing.approach="random":(a.sequencing.sequence=
c,z=!0));"random"===a.sequencing.approach&&delete a.sequencing.sequence;if(!0===z){c=Object.keys(a.los);k=c.length;for(e=0;e<k;e++)a.los[c[e]].can_be_shown=!1,a.los[c[e]].groups=[];r=!1;e=Object.keys(a.sequencing.sequence);_nGroups=e.length;for(var g=0;g<_nGroups;g++){a.sequencing.sequence[e[g]]=SGAME.Sequencing.initGroupSequence(a.sequencing.sequence[e[g]]);for(var n=a.sequencing.sequence[e[g]],s=0;s<n.los.length;s++)a.los[n.los[s]].groups.push(n.id),a.los[n.los[s]].can_be_shown=!0===n.can_be_shown,
!0===a.los[n.los[s]].can_be_shown&&(r=!0)}for(e=0;e<k;e++)"undefined"!==typeof a.los[c[e]].groups&&0!==a.los[c[e]].groups.length||delete a.los[c[e]];k=Object.keys(a.los).length}"string"!==typeof a.assets_path&&(a.assets_path="/assets/sgame/");A="string"==typeof d.lrs;!0===A&&SGAME.Analytics.init(a);SGAME.Messenger.init();SGAME.Fancybox.init(a.assets_path);SGAME.TrafficLight.init(a.assets_path);SGAME.Sequencing.init(a.sequencing);!0===z&&(E=SGAME.Sequencing.getNLOsForTracking(a.sequencing.sequence,
a.los));SGAME.Debugger.log("SGAME settings loaded");SGAME.Debugger.log(a)},triggerLO:function(b,c){switch(a.sequencing.interruptions){case "no_restrictions":return F(b,c);case "n_times":return x>=a.sequencing.interruptions_n?B(b,c):F(b,c);case "1_per_timeperiod":return"undefined"!==typeof t&&(new Date-t)/1E3<=a.sequencing.interruptions_n?B(b,c):F(b,c)}},showLO:G,showRandomLO:function(a){SGAME.API.requestLOMetadata(void 0,function(b){G(b,a)},function(){"function"===typeof a&&a(null,null)})},closeLO:function(){SGAME.Fancybox.closeCurrentFancybox()},
getSettings:function(){return a},losCanBeShown:function(a){return!1===r?!1:"undefined"===typeof a?r:0<I(H(a)).length},successWhenNoLOs:function(a){return N(a)},onConnectedToVLE:function(){"onstart"===a.game_settings.completion_status&&(n.progress_measure=1,n.completion_status="completed");"onstart"===a.game_settings.success_status&&(n.score=1,n.success_status="passed");if("onstart"===a.game_settings.completion_status||"onstart"===a.game_settings.success_status)SGAME.Messenger.sendMessage({key:"tracking",
value:n}),setTimeout(function(){!0===M()&&(D(),L(function(){D()}))},500)},getVLEData:function(){return s},setVLEData:function(a){s=a;if(!0===A)SGAME.Analytics.onVLEDataReceived(s)}}}();SGAME.Observer=function(g){var c=!0,q=g,a=g,m=g,s,n,l,u,v,b,p=function(){m=a=q=g;s=Date.now();n=!1;b=v=u=l=g},f=function(){!1===a.acts_as_asset&&"undefined"!==typeof m&&(m.addListener("cmi.success_status",function(a){l=a;"passed"===l&&"green"!=SGAME.TrafficLight.getCurrentColor()&&(SGAME.TrafficLight.stop(),SGAME.TrafficLight.changeColor("green"))}),m.addListener("cmi.score.scaled",function(a){u=a;0.8<=u&&"green"!=SGAME.TrafficLight.getCurrentColor()&&(SGAME.TrafficLight.stop(),SGAME.TrafficLight.changeColor("green"))}),
m.addListener("cmi.completion_status",function(a){v=a}),m.addListener("cmi.progress_measure",function(a){b=a}))};return{start:function(b,l,k){if(!1===c||"undefined"!=typeof q)return null;c=!1;p();q=b;a=l;m=k;f();SGAME.TrafficLight.changeColor("red");if(!0===a.acts_as_asset){b:{b=a.lom_metadata;if(b.educational&&b.educational.typicalLearningTime&&b.educational.typicalLearningTime.duration&&(b=iso8601Parser.getDuration(b.educational.typicalLearningTime.duration)))break b;b=null}b=!b||0>=b?15:Math.min(0.5*
b,120);SGAME.TrafficLight.setUpBlink("yellow",0.5*b-0.5,0.5*b);SGAME.TrafficLight.changeColor("green",b)}},stop:function(){if(!0===c||"undefined"==typeof q)return null;c=!0;SGAME.TrafficLight.stop();var f=Math.round((Date.now()-s)/1E3);n="green"===SGAME.TrafficLight.getCurrentColor();f={lo_metadata:a,time:f,success:n};"undefined"!=typeof l&&(f.scorm_success_status=l);"undefined"!=typeof u&&(f.scorm_scaled_score=u);"undefined"!=typeof v&&(f.scorm_completion_status=v);"undefined"!=typeof b&&(f.scorm_progress_measure=
b);p();return f},isStopped:function(){return c}}}();SGAME.Utils=function(){var g=void 0;return{init:function(c){},getRandomElement:function(c){if("number"==typeof c)return c;var g;g=c.length-1;if("number"!=typeof g)throw{name:"Invalid number format exception"};g=Math.round(0+Math.random()*(g-0));return c[g]},loadScript:function(c,g){if("string"===typeof c&&"function"===typeof g){var a=document.getElementsByTagName("head")[0];if(a){var m=document.createElement("script");m.setAttribute("src",c);m.setAttribute("type","text/javascript");m.onreadystatechange=
