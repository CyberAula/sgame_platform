!function(e, t) {
  ...
  var h = function(n) {
    var e, d, b, o, i, h, f, g, w, u, l, T, C, a, E, v, s, c, y, k = "sizzle" + 1 * new Date, m = n.document, S = 0, r = 0, p = ue(), x = ue(), N = ue(), A = ue(), D = function(e, t) {
      ...
      return-1
    }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", I = "(?:\\\\.|[\\w-]|[^\x00-\\xa0])+", W = "\\[" + M + "*(" + I + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + M + "*\\]", $ = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", F = new RegExp(M + "+", "g"), 
    B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"), _ = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), U = new RegExp(M + "|>"), X = new RegExp($), V = new RegExp("^" + I + "$"), G = {ID:new RegExp("^#(" + I + ")"), CLASS:new RegExp("^\\.(" + I + ")"), TAG:new RegExp("^(" + I + "|[*])"), ATTR:new RegExp("^" + W), PSEUDO:new RegExp("^" + $), CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + M + "*(even|odd|(([+-]|)(\\d*)n|)" + 
    M + "*(?:([+-]|)" + M + "*(\\d+)|))" + M + "*\\)|)", "i"), bool:new RegExp("^(?:" + R + ")$", "i"), needsContext:new RegExp("^" + M + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + M + "*((?:-\\d)?\\d*)" + M + "*\\)|)(?=[^-]|$)", "i")}, Y = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)", "ig"), ne = function(e, t, n) {
      var r = "0x" + t - 65536;
    ...
    o ? (Q.set(e, i, !1), k.event.add(e, i, {namespace:!1, handler:function(e) {
      ...
      if(1 & e.isTrigger && this[i]) {
        if(r.length) {
          ...
          if(r = s.call(arguments), Q.set(this, i, r), t = o(this, i), this[i](), r !== (n = Q.get(this, i)) || t ? Q.set(this, i, !1) : n = {}, r !== n) {
  ...
  k.event = {global:{}, add:function(t, e, n, r, i) {
    ...
    if(v) {
      ...
      while(l--) {
        ...
        (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), k.event.global[d] = !0)
      }
    }
  ...
  k.extend(k.event, {trigger:function(e, t, n, r) {
    ...
    if(o = f = a = n = n || E, 3 !== n.nodeType && (8 !== n.nodeType && (!Tt.test(d + k.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, (e = e[k.expando] ? e : new k.Event(d, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : k.makeArray(t, 
    [e]), c = k.event.special[d] || {}, r || (!c.trigger || !1 !== c.trigger.apply(n, t)))))) {
      if(!r && (!c.noBubble && !x(n))) {
  ...
  text:"responseText", json:"responseJSON"}, converters:{"* text":String, "text html":!0, "text json":JSON.parse, "text xml":k.parseXML}, flatOptions:{url:!0, context:!0}}, ajaxSetup:function(e, t) {
    ...
    function l(e, t, n, r) {
      ...
      }(v, s, T, i), i ? (v.ifModified && ((u = T.getResponseHeader("Last-Modified")) && (k.lastModified[f] = u), (u = T.getResponseHeader("etag")) && (k.etag[f] = u)), 204 === e || "HEAD" === v.type ? l = "nocontent" : 304 === e ? l = "notmodified" : (l = s.state, o = s.data, i = !(a = s.error))) : (a = l, !e && l || (l = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || l) + "", i ? x.resolveWith(y, [o, l, T]) : x.rejectWith(y, [T, l, a]), T.statusCode(w), w = void 0, g && m.trigger(i ? 
      "ajaxSuccess" : "ajaxError", [T, v, i ? o : a]), b.fireWith(y, [T, l]), g && (m.trigger("ajaxComplete", [T, v]), --k.active || k.event.trigger("ajaxStop")))
    }
    return T
...
(function() {
  ...
  function parse(ua) {
    ...
    var name = getName(["Adobe AIR", "Arora", "Avant Browser", "Breach", "Camino", "Electron", "Epiphany", "Fennec", "Flock", "Galeon", "GreenBrowser", "iCab", "Iceweasel", "K-Meleon", "Konqueror", "Lunascape", "Maxthon", {"label":"Microsoft Edge", "pattern":"(?:Edge|Edg|EdgA|EdgiOS)"}, "Midori", "Nook Browser", "PaleMoon", "PhantomJS", "Raven", "Rekonq", "RockMelt", {"label":"Samsung Internet", "pattern":"SamsungBrowser"}, "SeaMonkey", {"label":"Silk", "pattern":"(?:Cloud9|Silk-Accelerated)"}, "Sleipnir", 
    "SlimBrowser", {"label":"SRWare Iron", "pattern":"Iron"}, "Sunrise", "Swiftfox", "Vivaldi", "Waterfox", "WebPositive", {"label":"Yandex Browser", "pattern":"YaBrowser"}, {"label":"UC Browser", "pattern":"UCBrowser"}, "Opera Mini", {"label":"Opera Mini", "pattern":"OPiOS"}, "Opera", {"label":"Opera", "pattern":"OPR"}, "Chromium", "Chrome", {"label":"Chrome", "pattern":"(?:HeadlessChrome)"}, {"label":"Chrome Mobile", "pattern":"(?:CriOS|CrMo)"}, {"label":"Firefox", "pattern":"(?:Firefox|Minefield)"}, 
    {"label":"Firefox for iOS", "pattern":"FxiOS"}, {"label":"IE", "pattern":"IEMobile"}, {"label":"IE", "pattern":"MSIE"}, "Safari"]);
    ...
    "Lumia", "iPad", "iPod", "iPhone", "Kindle", {"label":"Kindle Fire", "pattern":"(?:Cloud9|Silk-Accelerated)"}, "Nexus", "Nook", "PlayBook", "PlayStation Vita", "PlayStation", "TouchPad", "Transformer", {"label":"Wii U", "pattern":"WiiU"}, "Wii", "Xbox One", {"label":"Xbox 360", "pattern":"Xbox"}, "Xoom"]);
    var manufacturer = getManufacturer({"Apple":{"iPad":1, "iPhone":1, "iPod":1}, "Alcatel":{}, "Archos":{}, "Amazon":{"Kindle":1, "Kindle Fire":1}, "Asus":{"Transformer":1}, "Barnes & Noble":{"Nook":1}, "BlackBerry":{"PlayBook":1}, "Google":{"Google TV":1, "Nexus":1}, "HP":{"TouchPad":1}, "HTC":{}, "Huawei":{}, "Lenovo":{}, "LG":{}, "Microsoft":{"Xbox":1, "Xbox One":1}, "Motorola":{"Xoom":1}, "Nintendo":{"Wii U":1, "Wii":1}, "Nokia":{"Lumia":1}, "Oppo":{}, "Samsung":{"Galaxy S":1, "Galaxy S2":1, 
    "Galaxy S3":1, "Galaxy S4":1}, "Sony":{"PlayStation":1, "PlayStation Vita":1}, "Xiaomi":{"Mi":1, "Redmi":1}});
    ...
    if(name == "IE" && /\blike iPhone OS\b/.test(ua)) {
      ...
      if(/^iP/.test(product)) {
        ...
        if(name == "Konqueror" && /^Linux\b/i.test(os)) {
          os = "Kubuntu"
        }else {
          if(manufacturer && (manufacturer != "Google" && (/Chrome/.test(name) && !/\bMobile Safari\b/i.test(ua) || /\bVita\b/.test(product))) || /\bAndroid\b/.test(os) && (/^Chrome/.test(name) && /\bVersion\//i.test(ua))) {
            ...
            if(name == "Silk") {
              ...
              if(name == "UC Browser" && /\bUCWEB\b/.test(ua)) {
                description.push("speed mode")
              }else {
                if(name == "PaleMoon" && (data = /\bFirefox\/([\d.]+)\b/.exec(ua))) {
                  description.push("identifying as Firefox " + data[1])
                }else {
                  if(name == "Firefox" && (data = /\b(Mobile|Tablet|TV)\b/i.exec(ua))) {
                    os || (os = "Firefox OS");
                    product || (product = data[1])
                  }else {
                    if(!name || (data = !/\bMinefield\b/i.test(ua) && /\b(?:Firefox|Safari)\b/.exec(name))) {
                      ...
                      if(name == "Electron" && (data = (/\bChrome\/([\d.]+)\b/.exec(ua) || 0)[1])) {
    ...
    if(useFeatures) {
      if(isHostType(context, "global")) {
        ...
        if(rhino) {
          ...
          if(typeof context.process == "object" && (!context.process.browser && (data = context.process))) {
            if(typeof data.versions == "object") {
              if(typeof data.versions.electron == "string") {
                ...
                if(typeof data.versions.nw == "string") {
        ...
        if(getClassOf(data = context.runtime) == airRuntimeClass) {
          ...
          if(getClassOf(data = context.phantom) == phantomClass) {
            ...
            if(typeof doc.documentMode == "number" && (data = /\bTrident\/(\d+)/i.exec(ua))) {
              ...
              if(typeof doc.documentMode == "number" && /^(?:Chrome|Firefox)\b/.test(name)) {
    ...
    if(name == "Fennec" || name == "Firefox" && /\b(?:Android|Firefox OS|KaiOS)\b/.test(os)) {
      ...
      if(name == "Maxthon" && version) {
        ...
        if(/\bXbox\b/i.test(product)) {
          ...
          if((/^(?:Chrome|IE|Opera)$/.test(name) || name && (!product && !/Browser|Mobi/.test(name))) && (os == "Windows CE" || /Mobi/i.test(ua))) {
            name += " Mobile"
          }else {
            if(name == "IE" && useFeatures) {
              try {
              ...
              if((/\bBlackBerry\b/.test(product) || /\bBB10\b/.test(ua)) && (data = (RegExp(product.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(ua) || 0)[1] || version)) {
                ...
                if(this != forOwn && (product != "Wii" && ((useFeatures && opera || (/Opera/.test(name) && /\b(?:MSIE|Firefox)\b/i.test(ua) || (name == "Firefox" && /\bOS X (?:\d+\.){2,}/.test(os) || name == "IE" && (os && (!/^Win/.test(os) && version > 5.5) || (/\bWindows XP\b/.test(os) && version > 8 || version == 8 && !/\bTrident\b/.test(ua)))))) && (!reOpera.test(data = parse.call(forOwn, ua.replace(reOpera, "") + ";")) && data.name)))) {
    ...
    if(name == "Opera" && (data = /\bzbov|zvav$/.exec(os))) {
      ...
      if(name == "Safari" && /\bChrome\b/.exec(layout && layout[1])) {
        description.unshift("desktop mode");
        name = "Chrome Mobile";
        version = null;
        if(/\bOS X\b/.test(os)) {
        ...
        if(/\bSRWare Iron\b/.test(name) && !version) {
    ...
    if((data = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(arch)) && !/\bi686\b/i.test(arch)) {
      ...
      if(os && (/^OS X/.test(os.family) && (name == "Chrome" && parseFloat(version) >= 39))) {
        os.architecture = 64
      }
    }
    ua || (ua = null);
    ...
    platform.os = os || {"architecture":null, "family":null, "version":null, "toString":function() {
      return"null"
    }};
...
SGAME_GATEWAY.Messenger = function() {
  ...
  var _onTrackingDataReceived = function(data) {
    if(SGAME_GATEWAY.CORE.isConnected() === true) {
      SGAME_GATEWAY.CORE.updateTrackingData(data.progress_measure, data.score, data.completion_status, data.success_status)
    }
  };
