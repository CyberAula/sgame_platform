...
;SGAME_GATEWAY = function() {
  var init = function() {
    return SGAME_GATEWAY.CORE.init()
  };
  return{init:init}
}();
...
SGAME_GATEWAY.CORE = function() {
  ...
  return{init:init, isConnected:isConnected, updateProgressMeasure:updateProgressMeasure, updateCompletionStatus:updateCompletionStatus, updateScore:updateScore, updateSuccessStatus:updateSuccessStatus, onExit:onExit, getAPIWrapper:getAPIWrapper, getLMSAPIInstance:getLMSAPIInstance}
}();
