VE_SGAME_Locales = {
	"en": {
		...
		"i.Publishing"				: "Publishing",
		"i.Publish_confirmation"	: "You are going to save and publish this Presentation on the SGAME Platform. After this, the presentation will be public and anyone will be able to access it. What would you like to do?",
		"i.Quiz"					: "Quiz",
		...
		"i.Unpublishing"			: "Unpublishing",
		"i.Unpublish_confirmation"	: "You are going to unpublish this Presentation from the SGAME Platform. After this, the presentation will be private and only you will be able to access it. What would you like to do?",
		"i.Unknown"					: "Unknown",
	...
	"es": {
		...
		"i.walkWelcome7_1"			: "Este botón te permite publicar tu presentación en la plataforma SGAME. Si no has terminado tu presentación, puedes guardarla como borrador para mantenerla privada y terminarla después.",
		...
		"i.walkSettings1_3"			: "El título y el avatar (una imagen que identifica tu presentación en la plataforma SGAME) son campos obligatorios, de modo que debes rellenarlos antes de publicar la presentación.",
		"i.walkSettings1_4"			: "A la izquierda, puedes ver una previsualización de como tu presentación será mostrada en la plataforma SGAME.",
		"i.walkSettings2_1"			: "Escribe un título (Obligatorio)",
		"i.walkSettings2_2"			: "Escribe el título de tu presentación en esta caja de texto. Este titulo es importante porque es el que se mostrará en la plataforma SGAME y el que verán el resto de usuarios.",
		"i.walkSettings3_1"			: "Añade un avatar para tu presentación (Obligatorio)",
		"i.walkSettings3_2"			: "Pulsa sobre este botón para elegir una imagen que represente a tu presentación. Esta imagen será el avatar de tu presentación y es importante porque será mostrada en la plataforma SGAME, permitiendo a los usuarios identificar la presentación.",
		...
		"i.walkSettings5_3"			: "Esta descripción será mostrada en la plataforma SGAME en la página de esta presentación. Por lo tanto, todos los usuarios que accedan a esta presentación podrán leerla.",
		...
		"i.walkSettings7_3"			: "Estas palabras clave son muy útiles para categorizar la presentación. Además, también se emplean como términos de búsqueda en la plataforma SGAME (asi como en otros repositorios), y por lo tanto añadir palabras clave a una presentación facilita su búsqueda y acceso.",
		...
		"i.walkSettings8_3"			: "Para subir un fichero adjunto debes haber guardado previamente la presentación. Una vez subido el fichero adjunto, los usuarios podrán descargarlo desde la página de la presentación en la plataforma SGAME.",
		...
		"i.walkPublication1_2"		: "En esta pantalla podrás cambiar los permisos que tendrán el resto de usuarios de la plataforma SGAME sobre tu presentación una vez publicada. Podrás cambiar esta configuración en cualquier momento.",
		...
		"i.Publishing"				: "Publicando",
		"i.Publish_confirmation"	: "Vas a guardar y publicar esta presentación en SGAME. Después de esto, la presentación será pública y cualquiera podrá acceder a ella. ¿Qué deseas hacer?",
		"i.Quiz"					: "Quiz",
		...
		"i.Unpublishing"			: "Retirando",
		"i.Unpublish_confirmation"	: "Vas a retirar la publicación de esta presentación de la plataforma SGAME. Después de esto la presentación será privada y solo tú podras acceder a ella. ¿Qué deseas hacer?",
